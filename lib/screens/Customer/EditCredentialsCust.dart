...
//}
class EditCredentialsCust extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return new MaterialApp(
      ...
      home: new CredentialsCust(),
    );
  }
}

class  CredentialsCust extends StatefulWidget {
  @override
  _CredentialsCustState createState() => _CredentialsCustState();
}

class _CredentialsCustState extends State<CredentialsCust> {
  ...
  Future updateUsername(String name)async{
    ...
    Firestore.instance.collection("MyUser").document(user.uid).updateData({
      'User_name': name,
    });
  }
                                  ...
                                  Row(
                                    children: <Widget>[
                                      ...
                                      IconButton(
                                        ...
                                        onPressed: (){
                                          _Updateusername(context,userData.username);
                                        },
                                      ),
                                  ...
                                  Row(
                                    children: <Widget>[
                                      ...
                                      IconButton(
                                        icon: Icon(Icons.edit),
                                        onPressed: (){
                                          _UpdatephoneNo(context,userData.phone);
                                        },
                                      ),
                                      new Divider(height: 2.0,),
                                    ],
                                  ...
                                  Row(
                                    children: <Widget>[
                                      ...
                                      IconButton(
                                        icon: Icon(Icons.edit),
                                        onPressed: (){
                                          _Updatecnic(context,userData.cnic);
                                        },
                                      ),
                                      new Divider(height: 2.0,),
                                    ],
                                  ...
                                  Row(
                                    children: <Widget>[
                                      ...
                                      IconButton(
                                        icon: Icon(Icons.edit),
                                        onPressed: (){
                                          _Updateaddress(context,userData.address);
                                        },
                                      ),
                                      new Divider(height: 2.0,),
                                    ],
